export default function LaravelBanner() {
    return (
        {/*
        Note to self: JSX expressions must have one parent element!
        That means we can't have two top-level elements in the return statement.
        So wrap these jokers in a div or something.
        */}
        <div className="single-parent-element">
