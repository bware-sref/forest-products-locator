    ...
    return (
        <AppLayout>
            ...
            <div className="flex min-h-180 flex-col items-center bg-nature p-6 text-beluga lg:justify-center lg:p-8 dark:bg-nature">
                <div className="flex flex-col w-full items-start justify-start opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0 lg:max-w-7xl py-8 px-8">                    
