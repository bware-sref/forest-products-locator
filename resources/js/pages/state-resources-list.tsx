    ...
    return (
        <AppLayout>
            ...
            <div className="mx-auto flex flex-col max-w-full md:w-6xl lg:w-7xl xl:max-w-7xl">
                <div className="flex flex-col max-w-83.75 lg:max-w-3xl px-6">
             ...
             */}
             <div className="cards mx-auto mt-4 py-6 px-5 flex flex-col flex-wrap md:flex-row w-full md:w-6xl lg:w-7xl max-w-full xl:max-w-7xl items-stretch justify-between gap-8 lg:gap-6 Xbg-pink-500">
                    ...
                    <Card key={resource.id} className="w-full md:w-55 lg:w-70 lg:max-w-70 xl:w-87.5 xl:max-w-95 pt-0 border-0 rounded-2xl bg-coupe">
                        <CardHeader className="bg-coupe py-4 xl:pt-6 xl:pb-3 rounded-t-2xl">
                            <CardTitle className="text-beluga">
                                <Link
                                    href={'/state-resources/' + state.abbreviation + '/' + resource.id}
