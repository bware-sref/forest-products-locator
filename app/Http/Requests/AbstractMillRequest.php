...
abstract class AbstractMillRequest extends FormRequest
{
    /**
    ...
    protected function prepareForValidation(): void
    {
        ...
        self::mergeSubmitterIp();
        self::mergeStatus();

        self::handleMailingAddress();

        // Log::debug('Data after merging additional fields in prepareForValidation(): ', $this->all());
    }


    protected function mergeSubmitterIp(): void
    {
        $this->merge([
    ...
    protected function mergeStatus(): void
    {
        $this->merge([
    ...
    protected function handleMailingAddress(): void
    {
