 ...
 */
class StateContactCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\StateContact::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/state-contact');
    ...
    {
        CRUD::setValidation(StateContactRequest::class);
