...
#[Signature('zed:process-mill-state {mill* : Id(s) of the Mill(s) to process}')]
#[Description('Dispatches ProcessMillState job(s) for the Mill(s) specified by id(s)')]
class DispatchProcessMillState extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        foreach ($millIds as $millId) {
            ...
            ProcessMillState::dispatch($mill);
